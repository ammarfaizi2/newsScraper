...
use Phx\Scrapers\Processors\Traits\Viva as VivaTrait;
 ...
 * @version 0.0.1
 */
final class Viva implements PhxScraperProcessor
{
	use VivaTrait;
	...
	public function run(): bool
	{
		...
		if (preg_match(
			"/^((https\:\/\/www\.viva\.co\.id\/berita\/.+)|(https\:\/\/www\.viva\.co\.id\/showbiz.+))/Usi",
			$this->url
		)) {
			return $this->mget() ? $this->beritaPath() : false;
		}
