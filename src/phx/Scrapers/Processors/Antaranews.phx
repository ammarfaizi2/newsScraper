...
use Phx\Scrapers\Processors\Traits\Antaranews as AntaranewsTrait;
 ...
 * @version 0.0.1
 */
final class Antaranews implements PhxScraperProcessor
{
	use AntaranewsTrait;
	...
	public function run(): bool
	{
		...
		return $this->mget() ? $this->scrape() : false;
