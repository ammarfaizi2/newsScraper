...
use Phx\Scrapers\Kliksamarinda;
use Phx\Scrapers\Korankaltim;
...
use Phx\Scrapers\Kabarmakassar;
...
use Phx\Scrapers\Terasmaluku;
use Phx\Scrapers\Beritamalutco;
use Phx\Scrapers\Beritamalutcom;
use Phx\Scrapers\Beritamalukuonline;
use Phx\Scrapers\Deliknews;
use Phx\Scrapers\Indonesiaberita;
use Phx\Scrapers\Beritapapua;
use Phx\Scrapers\Papuanews;
use Phx\Scrapers\Pasificpos;
use Phx\Scrapers\Kabarpapua;
use Phx\Scrapers\Tabloidjubi;
use Phx\Scrapers\Tribratanewspapuabarat;
use Phx\Scrapers\Papuatoday;
use Phx\Scrapers\Papuaus;
use Phx\Scrapers\Lensapapua;
...
switch ($argv[1]) {
	...
	case 'beritamalutco':
		$st = new Beritamalutco;
		break;

	case 'beritamalutcom':
		$st = new Beritamalutcom;
		break;

	case 'beritamalukuonline':
		$st = new Beritamalukuonline;
		break;
	...
	case 'indonesiaberita':
		$st = new Indonesiaberita;
		break;
	...
	case 'tribratanewspapuabarat':
		$st = new Tribratanewspapuabarat;
		break;
