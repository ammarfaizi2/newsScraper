 ...
 * @version 0.0.1
 */
final class Waspada implements PhxScraperProcessor
{
	/**
	 * @var string
	 */
	...
	public function run(): bool
	{
        ...
        if ( preg_match("/og\:image\" content=\"(.*?)\" \/>/", $l["out"], $m) ) {
            ...
            if( preg_match("/single\-post\-caption\">(.*?)<\/div>/", $l["out"], $m) ) {
	...
	{
		if ( preg_match("/<p><strong>(.*?)<br \/>[\s]*<span style=\"color\: \#808080\;\"/", $string, $m) ) {
            $rawContent = $m[1];
