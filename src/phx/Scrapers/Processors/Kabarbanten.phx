 ...
 * @version 0.0.1
 */
final class Kabarbanten implements PhxScraperProcessor
{
	/**
	 * @var string
	 */
	...
	private $host = "https://www.kabar-banten.com/";
	...
	{
		if( preg_match("/<div class=\"entry\">([\s|\S]*?)<div class=\"e3lan e3lan-post\">/", $string, $m) ) {
			$content = $m[1];
