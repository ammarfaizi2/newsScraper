 ...
 * @version 0.0.1
 */
final class Cybersulutnews implements PhxScraperProcessor
{
	/**
	 * @var string
	 */
	...
	private $host = "http://cybersulutnews.co.id/";
	...
	public function run(): bool
	{
        ...
        //     $author = trim(html_entity_decode(strip_tags("Cybersulutnews"), ENT_QUOTES, "UTF-8"));
        //     $this->authors[] = $author;
        //     icelog("Got author: " . $author);
        // }
	...
	{
		if( preg_match("/<div class=\"entry-content\">([\s|\S]*?)<footer>/", $string, $m) ) {
			$content = $m[1];
