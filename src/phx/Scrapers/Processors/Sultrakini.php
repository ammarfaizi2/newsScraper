 ...
 * @version 0.0.1
 */
final class Sultrakini implements PhxScraperProcessor
{
	/**
	 * @var string
	 */
	...
	private $host = "https://sultrakini.com/";
	...
	public function run(): bool
	{
        ...
        //     $author = trim(html_entity_decode(strip_tags("Sultrakini"), ENT_QUOTES, "UTF-8"));
        //     $this->authors[] = $author;
        //     icelog("Got author: " . $author);
        // }
        ...
        if ( preg_match("/class=\"post-published updated\" datetime=\"([^\+]+)\+/", $l["out"], $m) ) {
	...
	{
		if( preg_match("/<div class=\"entry-content clearfix single-post-content\">([\s|\S]*?)<div class=\"bs-irp /", $string, $m) ) {
			$content = $m[1];
