 ...
 * @version 0.0.1
 */
final class Liputanbengkulu implements PhxScraperProcessor
{
	/**
	 * @var string
	 */
	...
	private $host = "http://liputanbengkulu.com/";
	...
	{
		if( preg_match("/<div class=\"content-inner\">([\s|\S]*?)<div class=\"fb-comments\"/", $string, $m) ) {
            $content = $m[1];
