 ...
 * @version 0.0.1
 */
final class Sulutonline implements PhxScraperProcessor
{
	/**
	 * @var string
	 */
	...
	private $host = "http://sulutonline.com/";
	...
	public function run(): bool
	{
         ...
         * Get Title
         */
		if ( preg_match("/ <h1 class=\"title\" id=\"page-title\">(.*?)<\/h1>/", $l["out"], $m) ) {
        ...
        // } else {
        //     $author = trim(html_entity_decode(strip_tags("Sulutonline"), ENT_QUOTES, "UTF-8"));
        //     $this->authors[] = $author;
        //     icelog("Got author: " . $author);
        // }
	...
	{
		if( preg_match("/<div class=\"content\">([\s|\S]*?)<ul class=\"links inline\">/", $string, $m) ) {
			$content = $m[1];
