 ...
 * @version 0.0.1
 */
final class Kabarjatim implements PhxScraperProcessor
{
	/**
	 * @var string
	 */
	...
	private $host = "https://kabarjatim.com/";
	...
	public function run(): bool
	{
        ...
        if ( preg_match("/Reporter<\/span> <a href=\"https\:\/\/kabarjatim\.com\/author\/[^\"]+\">([^\<]+)<\/a>/", $l["out"], $o) ) {
	...
	{
		if( preg_match("/<div class=\"meta_right\">([\s|\S]*?)<div class=\"sharedaddy/", $string, $m) ) {
			$content = $m[1];
