 ...
 * @version 0.0.1
 */
final class Postkeadilan implements PhxScraperProcessor
{
	/**
	 * @var string
	 */
	...
	private $host = "http://postkeadilan.com/";
	...
	public function run(): bool
	{
         ...
         * Get Title
         */
		if ( preg_match("/<h1 class=\"single-title clearfix\">(.*?)<\/h1>/", $l["out"], $m) ) {
	...
	{
		if( preg_match("/<div class=\"entry-content clearfix\">([\s|\S]*?)<div class=\"ktz-socializer ktzsoc-floatbar/", $string, $m) ) {
			$content = $m[1];
