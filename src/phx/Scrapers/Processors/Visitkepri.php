 ...
 * @version 0.0.1
 */
final class Visitkepri implements PhxScraperProcessor
{
	/**
	 * @var string
	 */
	...
	private $host = "https://batampos.co.id";
	...
	public function run(): bool
	{
         ...
         * Get Title
         */
		if ( preg_match("/<h1 class=\"single-title inner-page-title\" itemprop=\"headline\">(.*?)<\/h1>/", $l["out"], $m) ) {
	...
	{
		if( preg_match("/itemprop=\"articleBody\">([\s|\S]+)<div class=\"sharedaddy sd-sharing-enabled\">/", $string, $m) ) {
            $content = $m[1];
