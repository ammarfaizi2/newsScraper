 ...
 * @version 0.0.1
 */
final class Infojogja implements PhxScraperProcessor
{
	/**
	 * @var string
	 */
	...
	private $host = "http://www.info-jogja.com/";
	...
	{
		if( preg_match("/itemprop=\'description articleBody\'>([\s|\S]*?)<div class=\'share-post\'>/", $string, $m) ) {
			$content = $m[1];
