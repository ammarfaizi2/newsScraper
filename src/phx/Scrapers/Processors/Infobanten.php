 ...
 * @version 0.0.1
 */
final class Infobanten implements PhxScraperProcessor
{
	/**
	 * @var string
	 */
	...
	private $host = "http://www.infobanten.com/";
	...
	public function run(): bool
	{
         ...
         * Get Title
         */
		if ( preg_match("/<h1 class=\"post-title item fn\" itemprop=\"name\">([\s\S]+)<\/h1>/", $l["out"], $m) ) {
	...
	{
		if( preg_match("/itemprop=\"articleBody\">([\s|\S]*?)<div class=\"fb-like\"/", $string, $m) ) {
			$content = $m[1];
