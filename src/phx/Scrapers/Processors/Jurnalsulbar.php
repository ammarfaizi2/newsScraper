 ...
 * @version 0.0.1
 */
final class Jurnalsulbar implements PhxScraperProcessor
{
	/**
	 * @var string
	 */
	...
	private $host = "https://jurnalsulbar.com/";
	...
	public function run(): bool
	{
        ...
        // } else {
        //     $author = trim(html_entity_decode(strip_tags("Jurnalsulbar"), ENT_QUOTES, "UTF-8"));
        //     $this->authors[] = $author;
        //     icelog("Got author: " . $author);
        // }
        //     $author = trim(html_entity_decode(strip_tags("Jurnalsulbar"), ENT_QUOTES, "UTF-8"));
