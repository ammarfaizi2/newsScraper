 ...
 * @version 0.0.1
 */
final class Aktual implements PhxScraperProcessor
{
	/**
	 * @var string
	 */
	...
	private $host = "http://www.aktual.com";
	...
	public function run(): bool
	{
        ...
        if ( preg_match("/<small><strong>\((.*?)\)<\/strong><\/small>/", $l["out"], $o) ) {
	...
	{
		if( preg_match("/<div class=\"td-ss-main-content\">([\s|\S]*?)<footer>/", $string, $m) ) {
            $content = $m[1];
