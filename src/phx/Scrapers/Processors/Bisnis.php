 ...
 * @version 0.0.1
 */
final class Bisnis implements PhxScraperProcessor
{
	/**
	 * @var string
	 */
	...
	public function run(): bool
	{
         ...
         * Get Title
         */
		if ( preg_match("/<\/ul> <h1>(.*?)<\/h1> <div class=\"author\">/", $l["out"], $m) ) {
	...
	{
		if( preg_match("/<div class=\"description\">([\s|\S]*?)<ul class=\"socmed share\">/", $string, $m) ) {
			$content = $m[1];
