 ...
 * @version 0.0.1
 */
final class Palembangpos implements PhxScraperProcessor
{
	/**
	 * @var string
	 */
	...
	private $host = "http://palembang-pos.com/";
	...
	public function run(): bool
	{
         ...
         * Get Images
         */
        if ( preg_match("/<img src=\"(.*?)\" class=\"ktz-first-featured\"/", $l["out"], $m) ) {
	...
	{
		if( preg_match("/<div class=\"entry-content clearfix\">[\s|\t|\n]*([\s|\S]*?)[\s|\t|\n]*<div class=\"bannersinglefot\">/", $string, $m) ) {
            $content = $m[1];
