 ...
 * @version 0.0.1
 */
final class Pedomanbengkulu implements PhxScraperProcessor
{
	/**
	 * @var string
	 */
	...
	private $host = "http://pedomanbengkulu.com/";
	...
	{
		if( preg_match("/<div class=\"td-post-content\">([\s|\S]*?)<div class=\"pvc_clear\"><\/div>/", $string, $m) ) {
            $content = $m[1];
