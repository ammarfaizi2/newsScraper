 ...
 * @version 0.0.1
 */
final class Goriau implements PhxScraperProcessor
{
	/**
	 * @var string
	 */
	...
	public function run(): bool
	{
         ...
         * Get Authors
         */
        if ( preg_match("/Penulis\: <span>(.*?)<\/span>/", $l["out"], $m) ) {
	...
	{
		if( preg_match("/itemprop=\"articleBody\">(.*?)<div style=\"margin\:20px/", $string, $m) ) {
