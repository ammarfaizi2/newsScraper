...
use Phx\Scrapers\Processors\Traits\Indonesiatimur as IndonesiatimurTrait;
 ...
 * @version 0.0.1
 */
final class Indonesiatimur implements PhxScraperProcessor
{
	use IndonesiatimurTrait;
	...
	public function run(): bool
	{
		...
		if (filter_var($this->url, FILTER_VALIDATE_URL)) {
			...
			icelog("Could not get html body");
			icelog("Skipping...");
			return false;
		}
