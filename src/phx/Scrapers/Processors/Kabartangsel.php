 ...
 * @version 0.0.1
 */
final class Kabartangsel implements PhxScraperProcessor
{
	/**
	 * @var string
	 */
	...
	private $host = "https://kabartangsel.com/";
	...
	public function run(): bool
	{
         ...
         * Get Title
         */
		if ( preg_match("/<h1 class=\"headline\">(.*?)<\/h1>/", $l["out"], $m) ) {
	...
	{
		if( preg_match("/<div id=\"content-area\">([\s|\S]*?)<div class=\"sharedaddy/", $string, $m) ) {
			$content = $m[1];
