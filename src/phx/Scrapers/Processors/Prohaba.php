 ...
 * @version 0.0.1
 */
final class Prohaba implements PhxScraperProcessor
{
	/**
	 * @var string
	 */
	...
	public function run(): bool
	{
         ...
         * Get Title
         */
		if ( preg_match("/clear\">(.*?)<\/div>/", $l["out"], $m) ) {
	...
	{
		if ( preg_match("/\"text_article\">([\s|\S]*?)<\/div><br/", $string, $m) ) {
            $rawContent = $m[1];
