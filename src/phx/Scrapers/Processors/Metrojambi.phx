 ...
 * @version 0.0.1
 */
final class Metrojambi implements PhxScraperProcessor
{
	/**
	 * @var string
	 */
	...
	public function run(): bool
	{
        ...
        // Get date and time
        if ( preg_match("/<div class=\"date left\">[\s|\t|\n]*[\S]+\, (.*?)[\s|\t|\n]*<\/div>/", $l["out"], $m) ) {
            $time = $m[1];
            ...
            if( count($exp) > 1 ) {
                ...
                if( isset($this->months[$sub_3]) ) {
                    ...
                    $time = $exp[2] . '/' . $real_mon . '/' . $exp[0] . ' 00:00:00';
                }
            }
