 ...
 * @version 0.0.1
 */
final class Rmolbengkulu implements PhxScraperProcessor
{
	/**
	 * @var string
	 */
	...
	private $host = "http://www.rmolbengkulu.com/";
	...
	public function run(): bool
	{
        ...
        if ( preg_match("/<b>LAPORAN<\/b>\: (.*?)[\s\t]+<\/p>/", $l["out"], $o) ) {
        ...
        // Get date and time
        if ( preg_match("/og\:url\" content=\"http\:\/\/www\.rmolbengkulu\.com\/read\/([0-9]+\/[0-9]+\/[0-9]+)\/[0-9]+\//", $l["out"], $m) ) {
        ...
        // if( preg_match_all("/property=\"schema\:about\" hreflang=\"en\">(.*?)<\/a>/", $l["out"], $n) ) {
        //     foreach ($n[1] AS $key => $tag) {
        //         $this->tags[] = ucwords($tag);
        //         icelog("Got tag: " . ucwords($tag));
        //     }
