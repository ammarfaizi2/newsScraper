 ...
 * @version 0.0.1
 */
final class Kupastuntas implements PhxScraperProcessor
{
	/**
	 * @var string
	 */
	...
	private $host = "https://www.kupastuntas.co/";
	...
	public function run(): bool
	{
        ...
        if ( preg_match("/<a href=\"[^\"]+\">(.*?)<\/a>[\s\t\n]+<div class=\"td-author-line\">/", $l["out"], $o) ) {
	...
	{
		if( preg_match("/<div class=\"td-post-content\">([\s|\S]*?)<div class=\'heateorFfcClear\'><\/div>/", $string, $m) ) {
            $content = $m[1];
