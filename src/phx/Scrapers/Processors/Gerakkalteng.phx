 ...
 * @version 0.0.1
 */
final class Gerakkalteng implements PhxScraperProcessor
{
	/**
	 * @var string
	 */
	...
	private $host = "https://gerakkalteng.com/";
	...
	public function run(): bool
	{
        ...
        if ( preg_match("/\"author\":{\"\@type\"\:\"Person\"\,\"name\"\:\"([^\"]+)\"/", $l["out"], $o) ) {
	...
	{
		if( preg_match("/<div class=\"entry-content entry clearfix\">([\s|\S]*?)<div class=\"post-footer post-footer-on-bottom\">/", $string, $m) ) {
			$content = $m[1];
