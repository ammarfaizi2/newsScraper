 ...
 * @version 0.0.1
 */
final class Lombokita implements PhxScraperProcessor
{
	/**
	 * @var string
	 */
	...
	private $host = "http://lombokita.com/";
	...
	{
		if( preg_match("/<div class=\"td-post-content\">([\s|\S]*?)<div class=\"td-post-source-tags\">/", $string, $m) ) {
			$content = $m[1];
