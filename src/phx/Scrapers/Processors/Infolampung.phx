 ...
 * @version 0.0.1
 */
final class Infolampung implements PhxScraperProcessor
{
	/**
	 * @var string
	 */
	...
	private $host = "https://radarlampung.co.id/";
	...
	public function run(): bool
	{
         ...
         * Get Title
         */
		if ( preg_match("/<h1 class='post-title4'>(.*?)<\/h1>/", $l["out"], $m) ) {
        ...
        // if ( preg_match("/<a href=\"[\S]+\">(.*?)<\/a><div class=\"td-author-line\">/", $l["out"], $o) ) {
	...
	{
		if( preg_match("/<div class=\'line\'><\/div>([\s|\S]*?)<div class=\'fb-like\'/", $string, $m) ) {
            $content = $m[1];
