...
use Phx\Scrapers\Processors\Traits\Kabardaerah as KabardaerahTrait;
 ...
 * @version 0.0.1
 */
final class Kabardaerah implements PhxScraperProcessor
{
	use KabardaerahTrait;
	...
	public function run(): bool
	{
		...
		return $this->mget() ? $this->runThreadScraper() : false;
