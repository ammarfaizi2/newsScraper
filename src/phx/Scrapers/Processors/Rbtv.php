 ...
 * @version 0.0.1
 */
final class Rbtv implements PhxScraperProcessor
{
	/**
	 * @var string
	 */
	...
	{
		if( preg_match("/<div id=\"content-main\" class=\"left relative\">([\s|\S]*?)<div class=\"getsocial gs-reaction-button\"><\/div>/", $string, $m) ) {
            $content = $m[1];
