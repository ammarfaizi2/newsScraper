 ...
 * @version 0.0.1
 */
final class Pikiranrakyat implements PhxScraperProcessor
{
	/**
	 * @var string
	 */
	...
	private $host = "http://www.pikiran-rakyat.com/";
	...
	public function run(): bool
	{
         ...
         * Get Title
         */
		if ( preg_match("/<h1 class=\"page-header\">(.*?)<\/h1>/", $l["out"], $m) ) {
	...
	{
		if( preg_match("/<div class=\"field field-name-body field-type-text-with-summary field-label-hidden\">([\s|\S]*?)<div class=\"field field-name-field-tags/", $string, $m) ) {
            $content = $m[1];
