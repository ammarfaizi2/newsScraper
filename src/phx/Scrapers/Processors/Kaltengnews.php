 ...
 * @version 0.0.1
 */
final class Kaltengnews implements PhxScraperProcessor
{
	/**
	 * @var string
	 */
	...
	private $host = "https://kaltengnews.com/";
	...
	public function run(): bool
	{
        ...
        if ( preg_match("/Penulis<\/div> <a href=\"[^\"]+\">(.*?)<\/a>/", $l["out"], $o) ) {
	...
	{
		if( preg_match("/<div class=\"td-post-content\">([\s|\S]*?)<div class=\"sharedaddy/", $string, $m) ) {
			$content = $m[1];
