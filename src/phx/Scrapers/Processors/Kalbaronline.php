 ...
 * @version 0.0.1
 */
final class Kalbaronline implements PhxScraperProcessor
{
	/**
	 * @var string
	 */
	...
	private $host = "https://www.kalbaronline.com/";
	...
	{
		if( preg_match("/<div class=\"td-post-content\">([\s|\S]*?)<div class='heateorFfcClear'>/", $string, $m) ) {
			$content = $m[1];
