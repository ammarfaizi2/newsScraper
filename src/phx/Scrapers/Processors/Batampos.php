 ...
 * @version 0.0.1
 */
final class Batampos implements PhxScraperProcessor
{
	/**
	 * @var string
	 */
	...
	public function run(): bool
	{
        ...
        if ( preg_match("/content=\"(.*?)\"><\/span><meta itemprop=\"datePublished\"/", $l["out"], $o) ) {
	...
	{
		// if( preg_match("/<div class=\"col-sm-16 sec-info\">([\s|\S]+)<div class=\"a2a\_kit/", $string, $m) ) {
        //     $content = $m[1];
