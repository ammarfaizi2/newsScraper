 ...
 * @version 0.0.1
 */
final class Ajnn implements PhxScraperProcessor
{
	/**
	 * @var string
	 */
	...
	public function run(): bool
	{
         ...
         * Get Authors
         */
        if ( preg_match("/rel=\"author\">(.*?)<\/a><\/span>/", $l["out"], $m) ) {
	...
	{
		if ( preg_match("/<div class=\"pillar\"><\/div>(.*?) <div class=\"row meta-share\">/", $string, $m) ) {
            $rawContent = $m[1];
