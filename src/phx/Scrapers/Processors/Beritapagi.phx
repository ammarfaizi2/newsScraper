 ...
 * @version 0.0.1
 */
final class Beritapagi implements PhxScraperProcessor
{
	/**
	 * @var string
	 */
	...
	private $host = "http://beritapagi.co.id/";
	...
	{
		if( preg_match("/<div class=\"entry\">([\s|\S]*?)<div id='jp-relatedposts' class='jp-relatedposts'>/", $string, $m) ) {
            $content = $m[1];
