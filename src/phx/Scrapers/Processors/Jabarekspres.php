 ...
 * @version 0.0.1
 */
final class Jabarekspres implements PhxScraperProcessor
{
	/**
	 * @var string
	 */
	...
	private $host = "http://jabarekspres.com/";
	...
	public function run(): bool
	{
        ...
        // Get date and time
        if ( preg_match("/itemprop=\"datePublished\" content=\"(.*?)\+/", $l["out"], $m) ) {
	...
	{
		if( preg_match("/<div class=\"td-post-content\">([\s|\S]*?)<div class=\"td-a-rec/", $string, $m) ) {
			$content = $m[1];
