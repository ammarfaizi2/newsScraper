...
use Phx\Scrapers\Processors\Traits\Suara as SuaraTrait;
 ...
 * @version 0.0.1
 */
final class Suara implements PhxScraperProcessor
{		
	use SuaraTrait;
	...
	public function run(): bool
	{
		...
		if (preg_match("/^https:\/\/www\.suara\.com\/news\//Usi", $this->url)) {
			return $this->mget() ? $this->newsPath() : false;
		}
		// } elseif (preg_match("/^https\:\/\/travel\./Usi", $this->url)) {
		// 	return $this->mget() ? $this->travelSubdomain() : false;
		// } elseif (preg_match("/^https\:\/\/health\./Usi", $this->url)) {
		// 	return $this->mget() ? $this->healthSubdomain() : false;
		// } elseif (preg_match("/^https\:\/\/finance\./Usi", $this->url)) {
		// 	return $this->mget() ? $this->financeSubdomain() : false;
		// }
