 ...
 * @version 0.0.1
 */
final class Detiksumsel implements PhxScraperProcessor
{
	/**
	 * @var string
	 */
	...
	private $host = "https://www.detiksumsel.com/";
	...
	public function run(): bool
	{
        ...
        if ( preg_match("/Penulis<\/div> <a href=\"[\S]+\">(.*?)<\/a>/", $l["out"], $o) ) {
	...
	{
		if( preg_match("/<div class=\"td-post-content\">[\s|\t|\n]*([\s|\S]*?)[\s|\t|\n]*<\/div>[\s|\t|\n]*<footer>[\s|\t|\n]*<div class=\"td-post-source-tags\">/", $string, $m) ) {
            $content = $m[1];
