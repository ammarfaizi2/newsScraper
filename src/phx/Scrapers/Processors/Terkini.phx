 ...
 * @version 0.0.1
 */
final class Terkini implements PhxScraperProcessor
{
	/**
	 * @var string
	 */
	...
	private $host = "https://makassar.terkini.id/";
	...
	public function run(): bool
	{
         ...
         * Get Title
         */
		if ( preg_match("/<h1 class=\"entry-title entry-bold\">(.*?)<\/h1>/", $l["out"], $m) ) {
        ...
        //     $author = trim(html_entity_decode(strip_tags("Terkini"), ENT_QUOTES, "UTF-8"));
        //     $this->authors[] = $author;
        //     icelog("Got author: " . $author);
        // }
	...
	{
		if( preg_match("/<div class=\"td-post-content\">([\s|\S]*?)<div class=\"td-info-author\">/", $string, $m) ) {
			$content = $m[1];
