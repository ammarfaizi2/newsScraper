 ...
 * @version 0.0.1
 */
final class Suryatopnews implements PhxScraperProcessor
{
	/**
	 * @var string
	 */
	...
	private $host = "http://suryatopnews.com/";
	...
	public function run(): bool
	{
        ...
        if ( preg_match("/Person\"><meta itemprop=\"name\" content=\"([^\"]+)\"/", $l["out"], $o) ) {
            ...
            $author = trim(html_entity_decode(strip_tags("Suryatopnews"), ENT_QUOTES, "UTF-8"));
            $this->authors[] = $author;
            icelog("Got author: " . $author);
        }
        //     $author = trim(html_entity_decode(strip_tags("Suryatopnews"), ENT_QUOTES, "UTF-8"));
