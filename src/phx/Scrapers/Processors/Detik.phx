...
use Phx\Scrapers\Processors\Traits\Detik as DetikTrait;
 ...
 * @version 0.0.1
 */
final class Detik implements PhxScraperProcessor
{
	use DetikTrait;
	...
	public function run(): bool
	{
		...
		if (preg_match("/^https\:\/\/news\./Usi", $this->url)) {
			return $this->mget() ? $this->newsSubdomain() : false;
