 ...
 * @version 0.0.1
 */
final class Merdeka implements PhxScraperProcessor
{
	/**
	 * @var string
	 */
	...
	private $host = "https://makassar.merdeka.com/";
	...
	public function run(): bool
	{
        ...
        //     $author = trim(html_entity_decode(strip_tags("Merdeka"), ENT_QUOTES, "UTF-8"));
        //     $this->authors[] = $author;
        //     icelog("Got author: " . $author);
        // }
	...
	{
		if( preg_match("/<div class=\"body-paragraph\">([\s|\S]*?)<div class=\"detail-box\">/", $string, $m) ) {
			$content = $m[1];
