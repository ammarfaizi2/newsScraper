 ...
 * @version 0.0.1
 */
final class Beritabali implements PhxScraperProcessor
{
	/**
	 * @var string
	 */
	...
	private $host = "https://www.beritabali.com/";
	...
	{
		if( preg_match("/<p class=\"isi-berita\">([\s|\S]*?)<ul class=\"rrssb-buttons\">/", $string, $m) ) {
			$content = $m[1];
            ...
            $content = preg_replace("/<div class=\"baca-juga\">([\s\S]+)<\/ul><\/div>/", "", $content);
