 ...
 * @version 0.0.1
 */
final class Harianrakyatbengkulu implements PhxScraperProcessor
{
	/**
	 * @var string
	 */
	...
	private $host = "http://harianrakyatbengkulu.com/ver3/";
	...
	public function run(): bool
	{
         ...
         * Get Images
         */
        if ( preg_match("/og\:image\" content=\"([\S]+)\?resize/", $l["out"], $m) ) {
	...
	{
		if( preg_match("/<div class=\"entry\">([\s|\S]*?)<div class=\"sharedaddy sd-sharing-enabled\">/", $string, $m) ) {
            $content = $m[1];
