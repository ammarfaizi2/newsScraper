 ...
 * @version 0.0.1
 */
final class Kepricoid implements PhxScraperProcessor
{
	/**
	 * @var string
	 */
	...
	public function run(): bool
	{
		...
		if ( preg_match("/og\:title\" content=\"(.*?)\"\/>/", $l["out"], $m) ) {
			$this->title = trim(html_entity_decode( strip_tags( str_replace(" | batampos.co.id", "", $m[1]) ), ENT_QUOTES, "UTF-8"));
        ...
        if ( preg_match("/Posted By\: <span class=\"fn\" itemprop=\"name\"><a href=\"[\S]+\">(.*?)<\/a>/", $l["out"], $o) ) {
