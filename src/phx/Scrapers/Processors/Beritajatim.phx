 ...
 * @version 0.0.1
 */
final class Beritajatim implements PhxScraperProcessor
{
	/**
	 * @var string
	 */
	...
	private $host = "http://beritajatim.com/";
	...
	public function run(): bool
	{
        ...
        if ( preg_match("/Reporter \: (.*?)<\/div>/", $l["out"], $o) ) {
	...
	{
		if( preg_match("/<div class=\"single-thumbnail\">([\s|\S]*?)<div class=\"single-tag\">/", $string, $m) ) {
			$content = $m[1];
